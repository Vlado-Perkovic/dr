...
razina faznih napona. Za mjerenje PEMS-a zaslužan je sklop komparatora preko
kojeg je moguće detektirati trenutak prolaska signala kroz referentni napon
virtualnog zvjezdišta. \missingfigure{slika esc}
...
podrška za simulaciju elektroničkih krugova te za obradu i vizualizaciju
mjernih podataka. U fazi istraživanja teme, ponašanje ključnih dijelova
pogonskog sklopa simulirano je u alatu \textit{LTspice}. To je omogućilo bolje
razumijevanje koncepata poput ponašanja struje pri komplementarnom signalu
PWM-a \todo{referenciraj}.
...
uvelike ubrzalo proces razvoja algoritma.
