...
\bigskip % Dodaje malo vertikalnog razmaka
		      ...
		      \begin{subfigure}[b]{0.4\textwidth}%
			      \resizebox{\linewidth}{!}{%
				      \begin{tikzpicture}[
					      ...
					      angle text/.style={font=\small, fill=white, inner sep=1pt} % Style for the angle label
					      ]
					      \def\rotorAngle{105}
...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[
		...
		\node (align_time) [decision, below=of align, yshift=-0.5cm]{Prošlo utitravanja?};
...
\begin{figure}[h!]
	\centering
	% \includesvg[width=\textwidth]{csv/Untitled.svg}
