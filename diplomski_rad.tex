...
% Za potrebe usporedbe korištena su dva sklopa:
% \begin{itemize}
% 	\item \textbf{ESC A:} Komercijalno dostupan sklop \textit{SimonK 30A}, koji radi na frekvenciji PWM-a od \SI{8}{\kilo\hertz}.
% 	\item \textbf{ESC B:} U sklopu ovog rada implementirano rješenje, koje radi na frekvenciji PWM-a od \SI{30}{\kilo\hertz}.
% \end{itemize}
% Usporedba se temelji na mjerenju vanjskih pokazatelja izvedbe u identičnim uvjetima.
%
...
% \SI{7.4}{\volt}. Brzina vrtnje mjerena je pomoću apsolutnog enkodera, a za
% vizualizaciju naponskih oblika korišten je digitalni osciloskop.
%
% \section{Analiza faznog napona i potvrda metode upravljanja}
% \label{sec:analiza_napona}
%
% Prvi korak u usporedbi bila je vizualna analiza valnog oblika napona na jednoj
% od faza motora tijekom rada. Snimke s osciloskopa, prikazane na slikama
% \ref{fig:esc_a_valni} i \ref{fig:esc_b_valni}, služe za potvrdu metode
% upravljanja i uočavanje razlika koje proizlaze iz različitih frekvencija PWM-a.
%
% \missingfigure{Snimka zaslona osciloskopa: valni oblik faznog napona za ESC A pri srednjoj brzini vrtnje.}
% \label{fig:esc_a_valni}
%
% \missingfigure{Snimka zaslona osciloskopa: valni oblik faznog napona za ESC B pri srednjoj brzini vrtnje.}
% \label{fig:esc_b_valni}
%
% Iz priloženih slika vidljivo je da oba sklopa koriste trapeznu metodu
% upravljanja, što se očituje u karakterističnom valnom obliku napona s periodima
% visoke impedancije. Glavna uočljiva razlika je u gustoći preklapanja PWM-a. Na
% slici \ref{fig:esc_a_valni} jasno je vidljiv grublji valni oblik, posljedica
% niže frekvencije od \SI{8}{\kilo\hertz}. Suprotno tome, slika
% \ref{fig:esc_b_valni} prikazuje znatno finiji valni oblik s manje izraženim
% šumom, što je rezultat više frekvencije od \SI{30}{\kilo\hertz} korištene u
% rješenju ESC B.
%
% \section{Usporedba radnog područja i sekvence pokretanja}
% \label{sec:usporedba_radnog_podrucja}
%
% Radno područje definirano je minimalnom i maksimalnom stabilnom brzinom vrtnje
% koju sklop može postići bez opterećenja. Mjerenja su provedena pri naponu
% napajanja od \SI{12}{\volt}, a rezultati su sažeti u tablici
% \ref{tab:usporedba_brzina}.
...
% ubrzanje enkoder
%
% esc A : 4900 @ 26% duty cycle -> snimljeno ubrzanje sa 1300 @ 8% na 4900 @ 26% 0409_8
% esc A : 6700 @ 100% duty cycle -> snimljeno ubrzanje sa 1300 @ 8% na 6700 @ 100% 0409_9

% esc B : 4400 @ 70% duty cycle -> snimljeno ubrzanje sa 1500 @ 23% na 4400 @ 26% 0409_15

\missingfigure{Tablica s usporedbom minimalne i maksimalne brzine vrtnje (RPM) za ESC A i ESC B.}
