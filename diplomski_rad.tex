...
signala PWM-a postavljena je na 30 kHz. Ova frekvencija predstavlja kompromis
...
položaju koji je \ang{180} stupnjeva pomaknut od željenog smjera magnetskog
polja, što bi rezultiralo neuspješnim poravnanjem. Zbog toga se izvode dva
početna, vremenski relativno dugačka koraka komutacije u trajanju oko 250ms.
...
vremenom sve više kasni, prilika za detekciju prolaska kroz nulu traje svega
nekoliko koraka. Stoga, važno je pouzdano detektirati i zabilježiti sve
...
bilježi trenutnu vrijednost brojača komutacijskog tajmera \texttt{TIM3} i
...
efektivno skraćuje trajanje trenutnog koraka, ubrzava stator pokušava "pobjeći"
...
sljedeći korak produžuje i polje statora usporava čime "čeka" rotor. Ove
...
modelu prikazanom u poglavlju \ref{sec:model_motora}.
...
\end{minted}
	\caption{Implementacija izračuna brzine pomoću predizračunate konstante.}
